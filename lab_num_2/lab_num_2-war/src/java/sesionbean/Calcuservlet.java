...
public class Calcuservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1> MULTIPICACIÓN = " + calcubean.multiplicacion(e, f) + "</h1>");
            out.println("<h1> DIVISIÓN = " + calcubean.division(g, h) + "</h1>");
            out.println("<h1> POTENCIACIÓN = " + calcubean.potenciacion(i, j) + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
